 ...
 * 
 * NOTE: I have picked this type somewhere from the internet, but to get the
 * actual type, do print the event.target object in the youtube embed video
 * player file in any of the handler methods of the iframe.
 */
